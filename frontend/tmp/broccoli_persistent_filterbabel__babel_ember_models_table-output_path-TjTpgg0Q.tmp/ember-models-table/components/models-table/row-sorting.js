define('ember-models-table/components/models-table/row-sorting', ['exports', 'ember-models-table/templates/components/models-table/row-sorting', 'ember-models-table/utils/macros'], function (exports, _rowSorting, _macros) {
  'use strict';
  ...
  exports.default = Ember.Component.extend({
     ...
     * @readonly
     */
    shownColumns: (0, _macros.shownColumns)('colspanForSortCell'),

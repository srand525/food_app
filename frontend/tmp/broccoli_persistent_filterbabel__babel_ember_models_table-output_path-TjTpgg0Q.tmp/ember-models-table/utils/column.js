define('ember-models-table/utils/column', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = Ember.Object.extend({
     ...
     * @readOnly
     */
    cssPropertyName: Ember.computed('propertyName', function () {
      return Ember.get(this, 'propertyName').replace(/\./g, '-');
    }),
     ...
     * @readOnly
     */
    sortAsc: Ember.computed.equal('sorting', 'asc'),
     ...
     * @readOnly
     */
    sortDesc: Ember.computed.equal('sorting', 'desc'),
     ...
     * @readOnly
     */
    filterUsed: Ember.computed.notEmpty('filterString'),
     ...
     * @readOnly
     */
    useSorting: Ember.computed('sortField', 'disableSorting', function () {
      return Ember.get(this, 'sortField') && !Ember.get(this, 'disableSorting');
    }),
     ...
     * @readonly
     */
    sortField: Ember.computed('sortedBy', 'propertyName', function () {
      return Ember.get(this, 'sortedBy') || Ember.get(this, 'propertyName');
    }).readOnly(),
     ...
     * @readOnly
     */
    useFilter: Ember.computed('filterField', 'disableFiltering', function () {
      return Ember.get(this, 'filterField') && !Ember.get(this, 'disableFiltering');
    }),
     ...
     * @readonly
     */
    filterField: Ember.computed('filteredBy', 'propertyName', function () {
      return Ember.get(this, 'filteredBy') || Ember.get(this, 'propertyName');
    }).readOnly(),
     ...
     * @private
     */
    cleanFilterString: Ember.observer('filterWithSelect', 'filterOptions.[]', 'filterString', function () {
      let filterOptions = Ember.get(this, 'filterOptions');

Index: addon/templates/components/models-table/row-grouping-cell.hbs
IDEA additional info:
Subsystem: com.intellij.openapi.diff.impl.patch.CharsetEP
<+>UTF-8
===================================================================
--- addon/templates/components/models-table/row-grouping-cell.hbs	(revision )
+++ addon/templates/components/models-table/row-grouping-cell.hbs	(revision )
@@ -0,0 +1,10 @@
+{{#if hasBlock}}
+  {{yield
...
+  }}
+{{else}}
+  <a href="#" {{action "toggleGroupedRows"}}>{{groupedValue}}</a>
+{{/if}}
\ No newline at end of file
Index: tests/integration/components/models-table/row-grouping-test.js
IDEA additional info:
Subsystem: com.intellij.openapi.diff.impl.patch.CharsetEP
<+>UTF-8
===================================================================
--- tests/integration/components/models-table/row-grouping-test.js	(revision )
+++ tests/integration/components/models-table/row-grouping-test.js	(revision )
@@ -0,0 +1,25 @@
+import { moduleForComponent, test } from 'ember-qunit';
+import hbs from 'htmlbars-inline-precompile';
+
+moduleForComponent('models-table/row-grouping', 'Integration | Component | models table/row grouping', {
+  integration: true
+});
+
...
+
+  this.render(hbs`{{models-table/row-grouping}}`);
+
+  assert.equal(this.$().text().trim(), '');
+
+  // Template block usage:
+  this.render(hbs`
+    {{#models-table/row-grouping}}
+      template block text
+    {{/models-table/row-grouping}}
+  `);
+
...
<+>UTF-8
===================================================================
--- addon/components/models-table.js	(revision b51e069268e90ae7144cc7f591196f1c087cf4e2)
...
+
+  /**
+   * @property currentGroupingField
+   * @type string
+   * @default null
+   */
+  currentGroupingField: null,
+
+  /**
...
+    return get(this, 'dataGroupProperties').map(optionStrToObj);
+  }),
+
   /**
    * `true` if some value is set to the global filter
...
+   * @readonly
+   */
+  groupedArrangedContent: computed('filteredContent.[]', 'sortProperties.[]', 'useDataGrouping', 'currentGroupingField', 'sortByGroupedFieldDirection', function () {
+    const useDataGrouping = get(this, 'useDataGrouping');
+    const currentGroupingField = get(this, 'currentGroupingField');
+    const filteredContent = get(this, 'filteredContent');
...
+
+    let _filteredContent = filteredContent.slice();
+    grouped = groupBy(_filteredContent, currentGroupingField);
+
+    keys(grouped).map(k => {
...
+   * @readonly
+   */
+  groupedVisibleContent: computed('groupedArrangedContent', 'pageSize', 'currentPageNumber', 'useDataGrouping', 'currentGroupingField', function () {
+    const useDataGrouping = get(this, 'useDataGrouping');
+    const currentGroupingField = get(this, 'currentGroupingField');
...
+      groupBy(groupedArrangedContent, currentGroupingField) :
+      groupBy(groupedArrangedContent.slice(startIndex, startIndex + pageSize), currentGroupingField);
+  }),
+
+  /**
+   * @type array
...
+      let currentSorting = get(column, 'sorting') || 'none';
       let newSorting = sortMap[currentSorting.toLowerCase()];
+      if (sortedBy === get(this, 'currentGroupingField')) {
+        const sortByGroupedFieldDirection = get(this, 'sortByGroupedFieldDirection');
...
+      if (collapsedGroupValues.includes(v)) {
+        collapsedGroupValues = collapsedGroupValues.without(v);
+        set(this, '_collapsedGroupValues', collapsedGroupValues);
+      }
+      else {
+        get(this, '_collapsedGroupValues').pushObject(v);
+      }
     }
   }
...
<+>UTF-8
===================================================================
--- tests/dummy/app/routes/examples/common-table.js	(revision b51e069268e90ae7144cc7f591196f1c087cf4e2)
...
+    controller.set('dataGroupProperties', ['age', 'city']);
+    controller.set('columns', A([
+      {propertyName: 'index'},
+      {propertyName: 'firstName'},
+      {propertyName: 'lastName'},
+      {propertyName: 'age', disableSorting: true},
+      {propertyName: 'city', disableSorting: true}
+    ]));
+  }
+});
...
<+>UTF-8
===================================================================
--- tests/dummy/app/controllers/examples/common-table.js	(revision b51e069268e90ae7144cc7f591196f1c087cf4e2)
...
<+>UTF-8
===================================================================
--- ember-cli-build.js	(revision b51e069268e90ae7144cc7f591196f1c087cf4e2)
...
<+>UTF-8
===================================================================
--- addon/themes/bootstrap3.js	(revision b51e069268e90ae7144cc7f591196f1c087cf4e2)
...
<+>UTF-8
===================================================================
--- addon/templates/components/models-table.hbs	(revision b51e069268e90ae7144cc7f591196f1c087cf4e2)
...
+        value=currentGroupingField
+        themeInstance=themeInstance
+        options=dataGroupOptions
+        currentGroupingField=currentGroupingField
...
+  {{#if useDataGrouping}}
+    {{component
+      themeInstance.components.data-group-by-select
+      value=currentGroupingField
+      options=dataGroupOptions
+      sortByGroupedFieldDirection=sortByGroupedFieldDirection
+      currentGroupingField=currentGroupingField
...
+    themeInstance.components.table
     ...
     visibleContent=visibleContent
     selectedItems=_selectedItems
+    collapsedGroupValues=_collapsedGroupValues
     useFilteringByColumns=useFilteringByColumns
     expandedItems=_expandedItems
     visibleProcessedColumns=visibleProcessedColumns
     allColumnsAreHidden=allColumnsAreHidden
...
+    toggleGroupedRows=(action "toggleGroupedRows")
     ...
     sendAction=(action "sendAction")
     data=data
Index: tests/integration/components/models-table/data-group-by-select-test.js
IDEA additional info:
Subsystem: com.intellij.openapi.diff.impl.patch.CharsetEP
<+>UTF-8
===================================================================
--- tests/integration/components/models-table/data-group-by-select-test.js	(revision )
+++ tests/integration/components/models-table/data-group-by-select-test.js	(revision )
@@ -0,0 +1,25 @@
+import { moduleForComponent, test } from 'ember-qunit';
+import hbs from 'htmlbars-inline-precompile';
+
+moduleForComponent('models-table/data-group-by-select', 'Integration | Component | models table/data group by select', {
+  integration: true
+});
+
+test('it renders', function(assert) {
...
+  // Handle any actions with this.on('myAction', function(val) { ... });
+
+  this.render(hbs`{{models-table/data-group-by-select}}`);
+
+  assert.equal(this.$().text().trim(), '');
+
+  // Template block usage:
+  this.render(hbs`
+    {{#models-table/data-group-by-select}}
+      template block text
+    {{/models-table/data-group-by-select}}
+  `);
+
+  assert.equal(this.$().text().trim(), 'template block text');
+});
Index: tests/integration/components/models-table/row-grouping-cell-test.js
IDEA additional info:
Subsystem: com.intellij.openapi.diff.impl.patch.CharsetEP
<+>UTF-8
===================================================================
--- tests/integration/components/models-table/row-grouping-cell-test.js	(revision )
+++ tests/integration/components/models-table/row-grouping-cell-test.js	(revision )
@@ -0,0 +1,25 @@
+import { moduleForComponent, test } from 'ember-qunit';
+import hbs from 'htmlbars-inline-precompile';
...
+  assert.equal(this.$().text().trim(), 'template block text');
+});
Index: app/components/models-table/row-grouping.js
IDEA additional info:
Subsystem: com.intellij.openapi.diff.impl.patch.CharsetEP
<+>UTF-8
===================================================================
--- app/components/models-table/row-grouping.js	(revision )
+++ app/components/models-table/row-grouping.js	(revision )
@@ -0,0 +1,1 @@
+export { default } from 'ember-models-table/components/models-table/row-grouping';
\ No newline at end of file
Index: addon/components/models-table/row-grouping.js
IDEA additional info:
Subsystem: com.intellij.openapi.diff.impl.patch.CharsetEP
<+>UTF-8
===================================================================
--- addon/components/models-table/row-grouping.js	(revision )
+++ addon/components/models-table/row-grouping.js	(revision )
@@ -0,0 +1,9 @@
+import Component from '@ember/component';
...
+  groupedValue: null
+});
Index: addon/templates/components/models-table/data-group-by-select.hbs
IDEA additional info:
Subsystem: com.intellij.openapi.diff.impl.patch.CharsetEP
<+>UTF-8
===================================================================
--- addon/templates/components/models-table/data-group-by-select.hbs	(revision )
+++ addon/templates/components/models-table/data-group-by-select.hbs	(revision )
@@ -0,0 +1,38 @@
+{{#if hasBlock}}
+  {{yield
...
+        <label>{{messages.groupByLabel}}</label>
+        {{component
...
+          class="changeGroupByField"
+        }}
+        <button class={{themeInstance.buttonLink}} onclick={{action "sort"}}>
+          <i class="{{if (is-equal "asc" sortByGroupedFieldDirection) themeInstance.sort-asc themeInstance.sort-desc}}"></i>
+        </button>
+      </div>
+    </div>
+  </div>
+{{/if}}
\ No newline at end of file
Index: addon/components/models-table/row-grouping-cell.js
IDEA additional info:
Subsystem: com.intellij.openapi.diff.impl.patch.CharsetEP
<+>UTF-8
===================================================================
--- addon/components/models-table/row-grouping-cell.js	(revision )
+++ addon/components/models-table/row-grouping-cell.js	(revision )
@@ -0,0 +1,15 @@
+import Component from '@ember/component';
...
+  }
+});
Index: app/components/models-table/data-group-by-select.js
IDEA additional info:
Subsystem: com.intellij.openapi.diff.impl.patch.CharsetEP
<+>UTF-8
===================================================================
--- app/components/models-table/data-group-by-select.js	(revision )
+++ app/components/models-table/data-group-by-select.js	(revision )
@@ -0,0 +1,1 @@
...
<+>UTF-8
===================================================================
--- addon/templates/components/models-table/table.hbs	(revision b51e069268e90ae7144cc7f591196f1c087cf4e2)
...
+    toggleGroupedRows=toggleGroupedRows
     ...
     sendAction=sendAction
     expandRow=expandRow
Index: addon/components/models-table/data-group-by-select.js
IDEA additional info:
Subsystem: com.intellij.openapi.diff.impl.patch.CharsetEP
<+>UTF-8
===================================================================
--- addon/components/models-table/data-group-by-select.js	(revision )
+++ addon/components/models-table/data-group-by-select.js	(revision )
@@ -0,0 +1,18 @@
+import Component from '@ember/component';
+import {get} from '@ember/object';
...
+  actions: {
+    sort() {
+      get(this, 'sort')({propertyName: get(this, 'currentGroupingField')});
+    }
+  }
+});
...
<+>UTF-8
===================================================================
--- addon/templates/components/models-table/table-body.hbs	(revision b51e069268e90ae7144cc7f591196f1c087cf4e2)
...
-      }}
+    {{#if useDataGrouping}}
+      {{#each groupedVisibleContentValuesOrder as |groupedValue|}}
+        {{component
+          themeInstance.components.row-grouping
+          visibleProcessedColumns=visibleProcessedColumns
+          groupedValue=groupedValue
+          toggleGroupedRows=toggleGroupedRows
+          themeInstance=themeInstance
+          sendAction=sendAction
+        }}
+        {{#unless (exists-in collapsedGroupValues groupedValue)}}
+          {{#each (get groupedVisibleContent groupedValue) as |record index|}}
+            {{component
+              themeInstance.components.row
+              record=record
+              visibleProcessedColumns=visibleProcessedColumns
+              index=index
+              selectedItems=selectedItems
...
+            {{#if (exists-in expandedItems record)}}
+              {{component
+                themeInstance.components.row-expand
+                expandedRowComponent=expandedRowComponent
+                record=record
+                processedColumns=processedColumns
+                messages=messages
...
<+>UTF-8
===================================================================
--- addon/themes/default.js	(revision b51e069268e90ae7144cc7f591196f1c087cf4e2)
...
+    'row-grouping-cell': 'models-table/row-grouping-cell',
     'row-sorting': 'models-table/row-sorting',
     'row-sorting-cell': 'models-table/row-sorting-cell',
     'select': 'models-table/select',
@@ -93,6 +96,13 @@
...
<+>UTF-8
===================================================================
--- tests/dummy/app/templates/examples/common-table.hbs	(revision b51e069268e90ae7144cc7f591196f1c087cf4e2)
+++ tests/dummy/app/templates/examples/common-table.hbs	(revision )
@@ -22,6 +22,7 @@
   (<code>multipleColumnsSorting</code>)</p>
 <p>{{input type="checkbox" name="doFilteringByHiddenColumns" checked=doFilteringByHiddenColumns}} Do filtering by hidden
   columns (<code>doFilteringByHiddenColumns</code>)</p>
+<p>{{input type="checkbox" name="useDataGrouping" checked=useDataGrouping}} Group rows by <code>age</code> value (<code>useDataGrouping</code>)</p>
...
+  currentGroupingField=currentGroupingField
 ...
 <div class="row">
Index: addon/templates/components/models-table/row-grouping.hbs
IDEA additional info:
Subsystem: com.intellij.openapi.diff.impl.patch.CharsetEP
<+>UTF-8
===================================================================
--- addon/templates/components/models-table/row-grouping.hbs	(revision )
+++ addon/templates/components/models-table/row-grouping.hbs	(revision )
@@ -0,0 +1,21 @@
+{{#if hasBlock}}
+  {{yield
+    (hash
+      themeInstance.components.row-grouping-cell
+      groupedValue=groupedValue
+      toggleGroupedRows=toggleGroupedRows
+      visibleProcessedColumns=visibleProcessedColumns
+      themeInstance=themeInstance

    ...
    <div class="ui simple dropdown item">
      ...
      <div class="menu floating left">
        {{#if columnDropdownOptions.showAll}}
          <div class="item" {{action "showAllColumns" bubbles=false}}>{{themeInstance.messages.columns-showAll}}</div>
        {{/if}}
        {{#if columnDropdownOptions.hideAll}}
          <div class="item" {{action "hideAllColumns" bubbles=false}}>{{themeInstance.messages.columns-hideAll}}</div>
        {{/if}}
        {{#if columnDropdownOptions.restoreDefaults}}
          <div class="item" {{action "restoreDefaultVisibility"
                                     bubbles=false}}>{{themeInstance.messages.columns-restoreDefaults}}</div>
        {{/if}}
